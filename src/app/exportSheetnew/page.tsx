...
import { ClassData, ClassProperty } from "@/lib/types";
                                    ...
                                    {COLUMNS.map((column) => (
                                        <td key={column.key} className="border-b px-1 py-s text-sm text-gray-600">
                                            ...
                                            {Array.isArray(cls.properties[column.key as keyof ClassProperty])
                                                ? (cls.properties[column.key as keyof ClassProperty] as any[]).join(', ') // eslint-disable-line @typescript-eslint/no-explicit-any
