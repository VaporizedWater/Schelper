...
//             if (dayToDate[class1Day] !== dayToDate[class2Day]) break;
...
//             } else {
//                 // No more possible conflicts with class1 since classes are sorted by start time
//                 break;
//             }
//         }
//     }
...
//             const conflicts = detectClassConflicts(state.classes.display);
//             dispatch({ type: 'SET_CONFLICTS', payload: conflicts });
//         }
//     }, [state.classes.display]);
...
//         currCombinedClass: state.classes.current,
